...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-white/8 bg-card/80",
      "backdrop-blur-sm shadow-card-dark",
      "transition-all duration-300 hover:shadow-card-hover hover:border-white/12",
      className
    )}
    {...props}
  />
