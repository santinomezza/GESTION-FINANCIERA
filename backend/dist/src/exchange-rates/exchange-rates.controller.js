...
let ExchangeRatesController = class ExchangeRatesController {
    ...
    convert(req, data) {
        return this.service.convertAmount(data.amount, data.fromCurrency, data.toCurrency);
    }
    async updateFromAPI(req) {
...
], ExchangeRatesController.prototype, "updateFromAPI", null);
