...
exports.clasificarComprobante = clasificarComprobante;
exports.parsearFechaArg = parsearFechaArg;
...
function validarCUIT(cuit) {
    ...
    if (remainder === 0 && digits[10] === 0 && cleanCuit.startsWith('20'))
        return true;
    if (remainder === 1 && digits[10] === 0 && cleanCuit.startsWith('23'))
        return true;
    if (remainder === 1 && digits[10] === 1 && cleanCuit.startsWith('27'))
        return true;
    return verificationDigit === digits[10];
}
function clasificarComprobante(numeroTicket) {
    if (!numeroTicket)
        return null;
...
function parsearFechaArg(fechaStr) {
    if (!fechaStr)
        return null;
...
//# sourceMappingURL=argentina-helpers.js.map